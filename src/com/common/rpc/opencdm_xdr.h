...
#if defined(__STDC__) || defined(__cplusplus)
extern bool_t xdr_rpc_request_is_type_supported(XDR *,
                                                rpc_request_is_type_supported*);
...
extern bool_t xdr_rpc_request_create_session(XDR *,
                                             rpc_request_create_session*);
extern bool_t xdr_rpc_request_load_session(XDR *, rpc_request_load_session*);
extern bool_t xdr_rpc_request_session_update(XDR *,
                                             rpc_request_session_update*);
extern bool_t xdr_rpc_request_session_release(XDR *,
                                              rpc_request_session_release*);
extern bool_t xdr_rpc_request_mediaengine_data(XDR *,
                                               rpc_request_mediaengine_data*);
extern bool_t xdr_rpc_response_generic(XDR *, rpc_response_generic*);
extern bool_t xdr_rpc_response_create_session(XDR *,
